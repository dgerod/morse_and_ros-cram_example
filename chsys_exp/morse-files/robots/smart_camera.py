...
class SmartCameraClass(morse.sensors.camera.CameraClass):
    """
    """
    ...
    def __init__(self, obj, parent=None):
        ...
        if not self.blender_cam:
            logger.error("no camera object associated to the smart camera. " +\
                  "The smart camera requires a standard Blender camera in its children.")
